		...
		$("#username").blur(function(){
			...
			function(data){
				...
				if(success){ // 可以添加
					...
					$("#usernameInfo").html("该用户名可以使用");
				}else{
					$("#usernameInfo").css("color","red");
					$("#usernameInfo").html("该用户名已被注册");
				}
			},
			// 数据格式
			"json"
...
<body style="margin: -2px">
	...
	<section class="sec">
		<form οnsubmit="return false" id="myform" action="${pageContext.request.contextPath }/UserAction_register" method="post">
			...
			<div class="register-box">
				<label for="username" class="username_label">
					真实姓名
					<input maxlength="20" name="name" type="text" placeholder="您的真实姓名" />
				</label>
				<div class="tips"></div>
			</div>
			...
			<div class="register-box">
				<label for="username" class="username_label">
					邮箱
					<input maxlength="50" name="email" type="text" placeholder="您的邮箱" />
				</label>
			...
			<div class="register-box">
				<label for="username" class="username_label">
					手机号
					<input maxlength="20" name="telephone" type="text" placeholder="您的手机号" />
				</label>
				<div class="tips"></div>
			</div>
