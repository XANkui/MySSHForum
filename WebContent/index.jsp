...
<body style="margin: -2px; height: 110px">
				...
				<div class="tab">
					<s:iterator value="#pastePageBean.list" var="paste">
						<div class="dvques">
							...
							<div class="quesContent">
								...
								<div class="qContent"
									style="width: 600px; height: 40px; overflow: hidden; white-space: normal; text-overflow: ellipsis;">
								...
								<div class="quesUser"
									...
									<image
										src="${pageContext.request.contextPath }/<s:property value="#paste.user.image"/>"
										class="imguser" />
									<div class="userName">
					...
					<div style="text-align: center">
						<div class="laypage-main">
							...
							<a href="${pageContext.request.contextPath }/GetDataAction_getPaste?currentPage=<s:property value="#pastePageBean.currentPage-1"/>" class="laypage-next">上一页</a>
							<a href="${pageContext.request.contextPath }/GetDataAction_getPaste?currentPage=1" class="laypage-last" title="尾页">首页</a>
							<s:if test="#pastePageBean.currentPage-3 > 0">
							<span>…</span> 
							</s:if>
							<s:if test="#pastePageBean.currentPage-2>0">
							<a href="${pageContext.request.contextPath }/GetDataAction_getPaste?currentPage=<s:property value="#pastePageBean.currentPage-2"/>"><s:property value="#pastePageBean.currentPage-2"/></a>
							</s:if>
							<s:if test="#pastePageBean.currentPage-1>0">
							<a href="${pageContext.request.contextPath }/GetDataAction_getPaste?currentPage=<s:property value="#pastePageBean.currentPage-1"/>"><s:property value="#pastePageBean.currentPage-1"/></a>
							</s:if>
							...
							<a href="${pageContext.request.contextPath }/GetDataAction_getPaste?currentPage=<s:property value="#pastePageBean.totalPage"/>" class="laypage-last" title="尾页">尾页</a>
							<a href="${pageContext.request.contextPath }/GetDataAction_getPaste?currentPage=<s:property value="#pastePageBean.currentPage+1"/>" class="laypage-next">下一页</a>
						</div>
					</div>
				</div>
			...
			<div class="dvorder">
				...
				<dl class="fly-panel fly-list-one">
					...
					<dd>
						...
						<span> <i class="iconfont">&#xe60b;</i> <s:property value="#paste.glanceover"/>
						</span>
					</dd>
					</s:iterator>
				</dl>
				...
				<dl class="fly-panel fly-list-one">
					...
					<dd>
						<a href="${pageContext.request.contextPath }/PasteAction_getDetail?pasteid=<s:property value="#paste.id"/>"><s:property value="#paste.title" /></a> <span> <i
							class="iconfont">&#xe60c;</i> <s:property value="#paste.ansnum"/>						</span>
					</dd>
					</s:iterator>
				</dl>
